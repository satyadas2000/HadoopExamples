...
public class PostalCodesReducer extends Reducer<IntWritable, Text, NullWritable, Text> {
TreeMap<Double, Text> recordRepo;
	...
	protected void reduce(IntWritable key, Iterable<Text> values,
		...
		for(Text val : values){
			...
			total_paid_amount = total_paid_amount+ Double.parseDouble(paid_amount.toString());

			total_tax_amount = total_tax_amount+ Double.parseDouble(tax_amount.toString());
		}
